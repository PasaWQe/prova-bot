...
const spinner2 = { 
  "interval": 150,
  "frames": ["SE INSCREVE LÁ LINDO : Youtube.com/supshockkj"]}
...
const banner2 = cfonts.render(('Canal: youtube.com/supshockkj'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SUPSHOCK CONSOLE`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'SUPSHOCK CONSOLE'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'SUPSHOCK CONSOLE';	
